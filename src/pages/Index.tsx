...
const reviews = [
  { name: "Дмитрий Р.", date: "27 июня 2026", text: "Вывезли строительный мусор после ремонта. Приехали в тот же день, быстро всё загрузили. Цена честная, никаких скрытых доплат. Спасибо!", stars: 5 },
  { name: "Алексей М.", date: "14 мая 2026", text: "Переезжали из двушки в трёшку. Приехали вовремя, аккуратно упаковали всё хрупкое, ни одной царапины. Уложились в 4 часа — быстрее, чем ожидал. Рекомендую!", stars: 5 },
  { name: "Игорь Т.", date: "31 марта 2026", text: "Перевозили дорогой антиквариат. Всё упаковали профессионально, довезли целым. Очень доволен отношением к работе и к вещам клиента.", stars: 5 },
  { name: "Наталья К.", date: "2 февраля 2026", text: "Отличная команда! Помогли с офисным переездом — вынесли серверное оборудование, разобрали и собрали мебель. Работали чётко и без суеты. Однозначно обращусь снова.", stars: 5 },
  { name: "Марина Ю.", date: "18 января 2026", text: "Обращалась уже второй раз. Снова всё на отлично — быстро, аккуратно, по адекватной цене. Теперь буду рекомендовать всем знакомым.", stars: 5 },
  { name: "Светлана В.", date: "9 декабря 2025", text: "Заказывала грузчиков для помощи с переездом. Ребята вежливые, работящие, всё сделали аккуратно. Даже холодильник через узкий коридор занесли без проблем.", stars: 5 },
]
