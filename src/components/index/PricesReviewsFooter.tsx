...
const reviews = [
  { name: "Дмитрий", date: "27 июня 2026", text: "Вывезли строительный мусор после ремонта. Приехали в тот же день, быстро всё загрузили. Цена честная, никаких скрытых доплат. Спасибо!", stars: 5 },
  { name: "Алексей", date: "14 мая 2026", text: "Переезжали из двушки в трёшку. Приехали вовремя, аккуратно упаковали всё хрупкое, ни одной царапины. Уложились в 4 часа — быстрее, чем ожидал. Рекомендую!", stars: 5 },
  ...
  { name: "Марина", date: "18 января 2026", text: "Обращалась уже второй раз. Снова всё на отлично — быстро, аккуратно, по адекватной цене. Теперь буду рекомендовать всем знакомым.", stars: 5 },
